...
DESCRIPTION = metadata.get('description', 'Analysis of BOM rainfall data')
AUTHOR = metadata.get('author', 'R Baker')
AUTHOR_EMAIL = metadata.get('author_email', 'rj71baker@gmail.com')
