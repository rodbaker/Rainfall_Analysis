...
# -*- coding: utf-8 -*-
#
# Rainfall_analysis documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = 'rainfall_analysisdoc'
...
texinfo_documents = [
    ('index', 'rainfall_analysis', u'Rainfall_analysis Documentation',
     u"R Baker", 'Rainfall_analysis',
     'Analysis of BOM rainfall data', 'Miscellaneous'),
]
